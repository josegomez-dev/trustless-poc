          ...
          <div className="relative p-6 border-b border-white/10">
            ...
            <div className="relative z-10 flex items-center space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-white/70 text-sm">Level {stats.level} • {stats.experience} XP</p>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white/5 rounded-lg p-4 border border-white/10 text-center">
                    <div className="text-2xl font-bold text-brand-300">{stats.totalDemosCompleted}</div>
                    <div className="text-white/70 text-sm">Demos Completed</div>
                  </div>
                  <div className="bg-white/5 rounded-lg p-4 border border-white/10 text-center">
                    <div className="text-2xl font-bold text-accent-300">{formatTime(stats.totalTimeSpent)}</div>
                ...
                {Object.keys(user.demoProgress).length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {Object.entries(user.demoProgress).map(([demoId, progress]) => (
                      <div key={demoId} className="bg-white/5 rounded-lg p-4 border border-white/10">
                        <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="flex items-center space-x-4 text-sm text-white/70">
                          <span>Steps: {progress.stepsCompleted}/{progress.totalSteps}</span>
