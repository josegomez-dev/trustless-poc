...
export default function XboxStyleConsole({
  loadingState,
  loadingProgress,
  gameTitle,
}: XboxStyleConsoleProps) {
    ...
    <div className='relative min-h-screen flex items-center justify-center overflow-hidden'>
      ...
      <div className='relative z-10' style={{ marginTop: '-350px' }}>
        ...
        <div className='relative'>
          ...
          {/* Main Console Body */}
          <div
            className='relative bg-gradient-to-br from-slate-900 via-black to-slate-800 rounded-3xl border-4 border-cyan-400 shadow-2xl shadow-cyan-400/50 overflow-hidden'
                ...
                {loadingState === 'initializing' && (
                  <div className='flex flex-col items-center justify-center h-full space-y-8'>
                    ...
                    <div className='space-y-3 text-center'>
                      <div className='text-white/80 text-sm'>Powering up gaming engine</div>
                      <div className='text-white/60 text-xs'>Loading system components...</div>
                    </div>
                ...
                {loadingState === 'loading' && (
                  <div className='flex flex-col items-center justify-center h-full space-y-6'>
                    ...
                    <div className='space-y-2'>
                      <h2 className='text-cyan-400 font-mono text-lg font-bold'>LOADING GAME</h2>
