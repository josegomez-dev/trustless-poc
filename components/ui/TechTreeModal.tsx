  ...
  const techTree: TechNode[] = [
    {
      ...
      description: 'The base layer of our trustless work system, built on Stellar blockchain for fast, secure, and cost-effective transactions.',
      icon: '⭐',
      ...
      children: [
        {
          ...
          description: 'Federated Byzantine Agreement (FBA) ensures network security and transaction finality in seconds.',
          icon: '🔒',
        ...
        },
        {
          ...
          description: 'Fast, low-cost transactions with built-in multi-signature support and atomic operations.',
          icon: '⚡',
    ...
    },
    {
      ...
      description: 'The heart of trustless work - automated escrow contracts that hold funds until conditions are met.',
      icon: '🏦',
      ...
      children: [
        {
          ...
          description: 'Multi-party signature requirements ensure no single party can access funds without consensus.',
          icon: '🔐',
        ...
        },
        {
          ...
          description: 'Automated contract execution based on time conditions and milestone completion.',
          icon: '⏰',
    ...
    },
    {
      ...
      description: 'Standardized protocols for different types of work arrangements and dispute resolution.',
      icon: '📋',
      ...
      children: [
        {
          ...
          description: 'Break down complex projects into verifiable milestones with automated payment triggers.',
          icon: '🎯',
        ...
        },
        {
          ...
          description: 'Decentralized arbitration system with multi-stakeholder voting and automated enforcement.',
          icon: '⚖️',
    ...
    },
    {
      ...
      description: 'Programmable contracts that automatically execute based on predefined conditions and triggers.',
      icon: '🤖',
      ...
      children: [
        {
          ...
          description: 'Pre-built, audited contract templates for common work arrangements and use cases.',
          icon: '📄',
        ...
        },
        {
          ...
          description: 'Build custom smart contracts with our visual contract builder and deployment tools.',
          icon: '🔧',
        ...
        >
          ...
          `}>
            ...
            <div className="flex items-center space-x-4">
              <div className={`text-4xl ${node.isUnlocked ? '' : 'grayscale'}`}>
                {node.icon}
              </div>
              <div className="flex-1">
                ...
                <p className={`text-sm ${
                  node.isUnlocked ? 'text-white/80' : 'text-gray-500'
                }`}>
                  {node.description}
                </p>
              </div>
          ...
          {activeView === 'tree' ? (
              ...
              <div className="lg:col-span-2">
                <div className="mb-6">
                  ...
                  <p className="text-white/70 text-sm">
                    Explore the technology behind Trustless Work. Click on nodes to learn more about each component.
                  </p>
                </div>
            ...
            <div className="space-y-8">
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold text-white mb-2">🏗️ Trustless Work Architecture</h3>
                <p className="text-white/70 text-sm">
                ...
                <div className="min-w-[800px] space-y-8">
                  ...
                  <div className="text-center">
                    <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-2xl p-6 border border-purple-400/30">
                      <div className="text-3xl mb-2">⚙️</div>
                      <h4 className="text-lg font-bold text-purple-300 mb-2">Application Logic Layer</h4>
                  ...
                  <div className="text-center">
                    <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-2xl p-6 border border-green-400/30">
                      ...
                      <h4 className="text-lg font-bold text-green-300 mb-2">Stellar Blockchain Layer</h4>
                  ...
                  <div className="mt-12">
                    <div className="bg-gradient-to-r from-yellow-500/10 to-orange-500/10 rounded-2xl p-6 border border-yellow-400/30">
                      <h4 className="text-lg font-bold text-yellow-300 mb-4 text-center">🔄 Data Flow Process</h4>
                  ...
                  <div className="mt-8">
                    <div className="bg-gradient-to-r from-red-500/10 to-pink-500/10 rounded-2xl p-6 border border-red-400/30">
                      <h4 className="text-lg font-bold text-red-300 mb-4 text-center">🔒 Security Features</h4>
