          ...
          <nav className='hidden md:block'>
            <div className='flex items-center space-x-8'>
              ...
              >
                ...
                >
                  <div className='relative flex items-center'>
                    <Image src='/images/icons/demos.png' alt='Demos' width={50} height={24} />
                  </div>
                </a>
              </Tooltip>
              ...
              >
                ...
                >
                  <div className='relative flex items-center'>
                    <Image src='/images/icons/console.png' alt='Store' width={50} height={24} />
                  </div>
                </a>
              </Tooltip>
              ...
              <Tooltip
                content={
                  <div>
                    <p className='text-white/90 text-sm font-medium'>Documentation Hub</p>
              ...
              >
                ...
                >
                  <div className='relative flex items-center'>
                    <Image src='/images/icons/docs.png' alt='Docs' width={50} height={24} />
                  </div>
                </a>
              </Tooltip>
            </div>
