...
const puzzles: Puzzle[] = [
  {
    ...
    correctAnswer: 1,
    explanation: 'Escrow systems hold funds in a smart contract until predefined conditions are met, ensuring trust between parties.',
    difficulty: 'easy',
    reward: 10
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'A 2-of-3 multi-signature wallet requires 2 out of 3 private keys to authorize a transaction, providing enhanced security.',
    difficulty: 'medium',
    reward: 20
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'When a Stellar escrow time lock expires, the funds automatically return to the sender, preventing permanent loss.',
    difficulty: 'hard',
    reward: 30
  }
]
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 mb-8">
            <p className="text-lg text-white/80 leading-relaxed mb-6">
              Solve complex escrow puzzles while learning Stellar blockchain fundamentals. 
              Complete challenges, unlock achievements, and become a DeFi expert!
            </p>
          ...
          <div className="text-center mb-8">
            <div className="flex justify-between items-center mb-4">
              <div className="text-left">
                <div className="text-white/60 text-sm">Puzzle {currentPuzzle + 1} of {puzzles.length}</div>
                ...
                <div className="space-y-3">
                  {achievements.length > 0 ? (
                    achievements.map((achievement, index) => (
                      <div key={index} className="p-3 bg-gradient-to-br from-yellow-500/20 to-orange-500/20 rounded-xl border border-yellow-400/30">
