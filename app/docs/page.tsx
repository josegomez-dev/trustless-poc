              ...
              <div className='max-w-6xl mx-auto'>
                ...
                <div className='text-center mb-16'>
                  ...
                  <p className='text-xl text-white/80 max-w-3xl mx-auto'>
                    Comprehensive technical guide to building decentralized work platforms on the
                    Stellar blockchain
                  </p>
                    ...
                    <div className='space-y-8'>
                      ...
                      <div className='grid md:grid-cols-3 gap-6'>
                        <div className='text-center p-6 bg-gradient-to-br from-brand-500/20 to-brand-400/20 rounded-xl border border-brand-400/30'>
                          ...
                          <p className='text-white/80'>
                            Automated fund management with programmable logic and no third-party
                            intermediaries
                          </p>
                        </div>
                        ...
                        <div className='grid md:grid-cols-2 gap-6'>
                          <div>
                            ...
                            <ul className='text-white/80 text-sm space-y-2'>
                              <li>
                                • <strong>Stellar Network:</strong> Consensus Protocol (SCP) with
                                3-5 second finality
                              </li>
                              <li>
                                • <strong>Smart Contracts:</strong> Stellar's native smart contract
                                capabilities
                              </li>
                              <li>
                                • <strong>Multi-Asset Support:</strong> Native and custom token
                                support
                              </li>
                              <li>
                                • <strong>Transaction Types:</strong> Payment, Path Payment, Manage
                                Offer operations
                              </li>
                            </ul>
                          </div>
                          <div>
                            ...
                            <ul className='text-white/80 text-sm space-y-2'>
                              <li>
                                • <strong>React Hooks:</strong> useEscrow, useWallet, useTransaction
                                hooks
                              </li>
                              <li>
                              ...
                              <li>
                                • <strong>Wallet Integration:</strong> Freighter, Albedo, and custom
                                wallet support
                              </li>
                              <li>
                                • <strong>State Management:</strong> React Context for global state
                                synchronization
                              </li>
                            </ul>
                          </div>
                      ...
                      <div className='bg-gradient-to-br from-brand-500/20 to-brand-400/20 rounded-xl p-6 border border-brand-400/30'>
                        ...
                        <ul className='text-white/80 space-y-2'>
                          ...
                          <li>
                            • <strong>Global Access:</strong> Borderless transactions with instant
                            settlement
                          </li>
                          <li>
                            • <strong>Security:</strong> Cryptographic security with Byzantine Fault
                            Tolerance
                          </li>
                          <li>
                            • <strong>Interoperability:</strong> Built-in bridges to traditional
                            financial systems
                          </li>
                          <li>
                            • <strong>Environmental:</strong> Carbon-neutral consensus mechanism
                          </li>
                        </ul>
                      </div>
                    </div>
                          ...
                          <div className='space-y-4'>
                            <div className='bg-gradient-to-br from-brand-500/20 to-brand-400/20 rounded-lg p-4 border border-brand-400/30'>
                              ...
                              <p className='text-white/80 text-sm'>
                                Stellar Consensus Protocol ensures network agreement in 3-5 seconds
                            ...
                            <div className='bg-gradient-to-br from-brand-500/20 to-brand-400/20 rounded-lg p-4 border border-brand-400/30'>
                              ...
                              <p className='text-white/80 text-sm'>
                                Payment, Path Payment, Manage Offer, and Set Options for complex
                                escrow logic
                              </p>
                            </div>
                          </div>
                      ...
                      <div className='bg-gradient-to-br from-white/5 to-white/10 rounded-xl p-6 border border-white/20'>
                        ...
                        <div className='grid md:grid-cols-2 gap-6'>
                          <div>
                            ...
                            <ul className='text-white/80 text-sm space-y-2'>
                              <li>
                                • <strong>UI Layer:</strong> React components with hooks and state
                                management
                              </li>
                              <li>
                              ...
                              <li>
                                • <strong>Logic Layer:</strong> Trustless Work SDK with business
                                logic
                              </li>
                              <li>
                                • <strong>Blockchain Layer:</strong> Stellar network integration and
                                smart contracts
                              </li>
                            </ul>
                          </div>
                          <div>
                            ...
                            <ul className='text-white/80 text-sm space-y-2'>
                              <li>
                                • <strong>UI → State:</strong> Components consume context state and
                                dispatch actions
                              </li>
                              <li>
                    ...
                    <div className='space-y-8'>
                      <div className='text-center mb-8'>
                        ...
                        <p className='text-lg text-white/80 max-w-2xl mx-auto'>
                          Build on Stellar with Trustless Work — comprehensive starter kits for
                          innovative apps using advanced escrow mechanics and enhanced Stellar
                          integrations.
                        </p>
                      </div>
                      ...
                      <div className='grid md:grid-cols-3 gap-6'>
                        ...
                        <div className='bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-400/30 rounded-2xl p-6 hover:border-cyan-400/50 transition-all duration-300 group relative'>
                          <div className='text-center mb-4'>
                            ...
                            <p className='text-white/70 text-sm mb-4'>
                              Create decentralized financial apps with escrow contracts and yield
                              optimization.
                            </p>
                          </div>
                        ...
                        <div className='bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-400/30 rounded-2xl p-6 hover:border-purple-400/50 transition-all duration-300 group relative'>
                          <div className='text-center mb-4'>
                            ...
                            <p className='text-white/70 text-sm mb-4'>
                              Build play-to-earn games with secure escrow for tournaments, rewards,
                              and trading.
                            </p>
                          </div>
